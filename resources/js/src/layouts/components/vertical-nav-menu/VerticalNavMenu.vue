  ...
  <div class="parentx">
    ...
    <vs-sidebar
      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <!-- Header -->
        <div class="header-sidebar flex items-end justify-between pt-2" slot="header">

          <!-- Logo -->
            <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
                <logo class="w-10 mr-4 fill-current text-primary" />
                <span class="vx-logo-text text-sm text-primary" v-show="isMouseEnter || !reduce" v-if="title">{{ title }}</span>
            </router-link>
          <!-- /Logo -->
